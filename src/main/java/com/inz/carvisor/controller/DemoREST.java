...
public class DemoREST {
    ...
    private void addMockedErrors(User user, Car car) {
        List.of(
                new ErrorBuilder().setUser(user).setDeviceLicensePlate(car.getLicensePlate()).setLocation("52.448235;16.907205").setUserName(user.getNameAndSurname()).setCar(car).setDate(getThreeDaysBeforeTimeStamp()).setTimestamp(getThreeDaysBeforeTimeStamp()).setType("P0003").setValue("Fuel Volume Regulator Control Circuit Low").build(),
                new ErrorBuilder().setUser(user).setDeviceLicensePlate(car.getLicensePlate()).setLocation("52.448235;16.907205").setUserName(user.getNameAndSurname()).setCar(car).setDate(getThreeDaysBeforeTimeStamp()).setTimestamp(getThreeDaysBeforeTimeStamp()).setType("P0036").setValue("HO2S Heater Control Circuit").build(),
                new ErrorBuilder().setUser(user).setDeviceLicensePlate(car.getLicensePlate()).setLocation("52.448235;16.907205").setUserName(user.getNameAndSurname()).setCar(car).setDate(getThreeDaysBeforeTimeStamp()).setTimestamp(getThreeDaysBeforeTimeStamp()).setType("P0059").setValue("HO2S Heater Resistance").build()
    ...
    private void addMockedUsers() {
        List.of(
                ...
                new UserBuilder().setNick("zenek").setName("Zenon").setSurname("Kołodziej").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage(extractBase64Picture(2, USER_PHOTOS_DIRECTORY_NAME)).setPhoneNumber(12378456).setNfcTag("AAB").build(),
                ...
                new UserBuilder().setNick("user5").setName("Piotr").setSurname("Błaszczyk").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage(extractBase64Picture(5, USER_PHOTOS_DIRECTORY_NAME)).setPhoneNumber(132213).setNfcTag("ACC").build(),
                ...
                new UserBuilder().setNick("user7").setName("Kamil").setSurname("Cieaślak").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage(extractBase64Picture(7, USER_PHOTOS_DIRECTORY_NAME)).setPhoneNumber(123451).setNfcTag("BCA").build(),
                new UserBuilder().setNick("user8").setName("Aleksander").setSurname("Zielizński").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage(extractBase64Picture(8, USER_PHOTOS_DIRECTORY_NAME)).setPhoneNumber(21344312).setNfcTag("ACA").build(),
