...
public class DataMocker {
    ...
    public static List<User> getUsers() {
        ...
        return List.of(
                ...
                new UserBuilder().setNick("zenek").setName("Zenon").setSurname("Kołodziej").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage("Image").setPhoneNumber(12378456).setNfcTag("AAB").build(),
                new UserBuilder().setNick("user3").setName("Maciej").setSurname("Jakubowski").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage("Image").setPhoneNumber(12354316).setNfcTag("ABC").build(),
                ...
                new UserBuilder().setNick("user5").setName("Piotr").setSurname("Błaszczyk").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage("Image").setPhoneNumber(132213).setNfcTag("ACC").build(),
                ...
                new UserBuilder().setNick("user7").setName("Kamil").setSurname("Cieaślak").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage("Image").setPhoneNumber(123451).setNfcTag("BCA").build(),
                new UserBuilder().setNick("user8").setName("Aleksander").setSurname("Zielizński").setPassword(DigestUtils.sha256Hex("xsba")).setUserPrivileges(UserPrivileges.STANDARD_USER).setImage("Image").setPhoneNumber(21344312).setNfcTag("ACA").build(),
